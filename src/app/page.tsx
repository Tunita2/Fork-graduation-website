...
export default function GraduationInvite() {
    ...
    try {
      ...
      if (result) {
        ...
        confetti({
          ...
          spread: 80,
          origin: { y: 0.6 },
          colors: ["#0F2A4A", "#D4AF37", "#F5F3EE", "#1A3F6F"]
        });
  ...
  const getCardColor = (index: number) => {
    const colors = ["bg-[#F5F3EE]", "bg-[#EDE9E0]", "bg-[#E5E1D8]"];
  ...
  const mapSteps = [
    {
      title: "Cổng chính cơ sở 03 Quang Trung",
      desc: "Đi vào cổng chính của cơ sở 03 Quang Trung, Trường Đại học Duy Tân.",
      coords: { x: "10%", y: "85%" }
    },
    {
      title: "Sảnh chính tòa nhà",
      desc: "Đi thẳng vào sảnh chính của tòa nhà, hướng về phía thang máy hoặc cầu thang bộ.",
      coords: { x: "35%", y: "60%" }
    },
    {
      title: "Lên tầng 4",
      desc: "Sử dụng thang máy hoặc cầu thang bộ để di chuyển lên tầng 4 của tòa nhà.",
      coords: { x: "65%", y: "40%" }
    },
    {
      title: "Hội trường tầng 4",
      desc: "Hội trường tầng 4 — nơi diễn ra Lễ trao bằng Tốt nghiệp chính thức.",
      coords: { x: "90%", y: "15%" }
    }
  ];
  ...
  const handleAddToCalendar = () => {
    ...
    const location = "Hội trường tầng 4, cơ sở 03 Quang Trung, Đại học Duy Tân, Đà Nẵng";
  ...
  return (
    <div className="relative min-h-screen selection:bg-[#0F2A4A] selection:text-white flex flex-col justify-between overflow-x-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        {/* Soft abstract blobs with deep burgundy/cream gradients */}
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#0F2A4A]/5 blur-[120px]" />
        <div className="absolute top-[40%] right-[-10%] w-[60%] h-[60%] rounded-full bg-[#D4AF37]/3 blur-[150px]" />
        <div className="absolute bottom-[-10%] left-[10%] w-[45%] h-[45%] rounded-full bg-[#0F2A4A]/5 blur-[120px]" />
      </div>
      ...
      <div className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-50">
        ...
        >
          {isPlaying ? (
            <>
              <Volume2 className="w-5 h-5 sm:w-5 sm:h-5 text-[#0F2A4A] animate-pulse flex-shrink-0" />
            ...
            <>
              <VolumeX className="w-5 h-5 sm:w-5 sm:h-5 text-[#0F2A4A] flex-shrink-0" />
              <span className="max-w-0 overflow-hidden group-hover:max-w-16 md:group-hover:max-w-20 transition-all duration-300 ease-out text-xs font-semibold whitespace-nowrap">
                Phát Nhạc
              </span>
            </>
      ...
      <header className="relative w-full py-8 sm:py-12 md:py-16 lg:py-24 px-3 sm:px-4 flex flex-col items-center justify-center z-10 text-center max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative w-60 h-72 sm:w-72 sm:h-80 md:w-80 md:h-96 mb-6 sm:mb-8 flex items-center justify-center filter drop-shadow-2xl">
            ...
            >
              {/* Photo Area */}
              <div className="relative w-full h-[85%] rounded-2xl overflow-hidden border border-zinc-100 bg-[#F5F3EE]">
                <Image 
                  src="/hero_avatar.jpg" 
              ...
              <div className="text-center pt-3 text-[#0F2A4A] font-serif font-bold tracking-wider text-sm md:text-base">
            ...
            <motion.div 
              ...
              className="absolute top-2 right-2 text-[#D4AF37]/70"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-6 left-2 text-[#D4AF37]/60"
            >
              <Sparkles className="w-6 h-6" />
            </motion.div>
          </div>

          <span className="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider text-[#0F2A4A] bg-[#0F2A4A]/10 border border-[#0F2A4A]/20 mb-4 inline-flex items-center gap-1.5 shadow-sm">
            <Award className="w-3.5 h-3.5" /> Graduation Day Invitation
          </span>

          <h1 className="font-serif text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-[#1A1A2E] leading-tight max-w-4xl px-2 sm:px-3">
            Lễ Tốt Nghiệp của <br className="sm:hidden" />
            <span className="text-gold-shimmer text-shadow-3d-gold font-serif relative inline-block py-1">
              Bùi Lê Tuấn
            </span>
          </h1>
          ...
          <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl text-zinc-600 max-w-xl mx-auto italic font-light px-3 sm:px-4 leading-relaxed">
            &ldquo;Tri thức là nền tảng, nhưng chính những con người đồng hành mới làm nên giá trị của cả hành trình.&rdquo;
          </p>
        </motion.div>
      </header>
      ...
      <section className="relative w-full max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-8 md:py-12 z-10 mb-12 sm:mb-16">
        ...
        >
          <h2 className="text-[#0F2A4A] text-xs sm:text-sm md:text-base font-bold tracking-widest uppercase mb-6 sm:mb-8 flex items-center justify-center gap-2 flex-wrap">
            ...
            {!timeLeft.isOver ? (
              ...
              >
                ...
                <div className="countdown-block py-3 sm:py-6 px-2 sm:px-4 flex flex-col items-center">
                  <span className="font-serif text-2xl sm:text-4xl md:text-5xl font-black text-[#0F2A4A] tracking-tight">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-8 py-3 sm:py-5 rounded-3xl bg-[#0F2A4A] border-2 border-[#D4AF37]/30 text-[#F5F3EE] shadow-xl animate-bounce flex-wrap justify-center"
              >
      ...
      <section className="relative w-full max-w-6xl mx-auto px-3 sm:px-4 py-6 sm:py-8 md:py-12 z-10 mb-12 sm:mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 items-stretch">
          ...
          <motion.div
            ...
            className="clay-card-navy p-6 sm:p-8 md:p-12 text-[#F5F3EE] flex flex-col justify-between"
          >
            <div>
              ...
              <div className="space-y-6 sm:space-y-8 mt-6 sm:mt-8">
                <div className="flex items-start gap-4">
                  <div className="p-2 sm:p-3 bg-white/10 rounded-2xl border border-white/10 shadow-inner flex-shrink-0">
                    <Calendar className="w-5 h-5 sm:w-6 sm:h-6 text-[#F5F3EE]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="p-2 sm:p-3 bg-white/10 rounded-2xl border border-white/10 shadow-inner flex-shrink-0">
                    <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-[#F5F3EE]" />
                  </div>
                  <div>
                    <h3 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-white/60 mb-1">Địa điểm</h3>
                    <p className="font-serif text-base sm:text-lg md:text-xl font-semibold">Hội trường tầng 4</p>
                    <p className="text-zinc-300 text-xs sm:text-sm mt-1 leading-relaxed">
                      Cơ sở 03 Quang Trung, Trường Đại học Duy Tân, Đà Nẵng.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="relative h-48 sm:h-64 md:h-72 rounded-3xl overflow-hidden shadow-lg border border-zinc-200/50 bg-[#F5F3EE] p-2">
              <div className="w-full h-full rounded-2xl overflow-hidden relative">
                {/* Burgundy styled tint overlay - maps iframe has mix-blend-mode for styling */}
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.0!2d108.2!3d16.07!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314219c0f3a5d2b1%3A0x1234567890abcdef!2s03+Quang+Trung%2C+%C4%90%C3%A0+N%E1%BA%B5ng!5e0!3m2!1svi!2s!4v1717830000000!5m2!1svi!2s" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0, filter: "sepia(8%) hue-rotate(190deg) saturate(85%) contrast(105%)" }} 
                  allowFullScreen={false} 
                  loading="lazy" 
                  referrerPolicy="no-referrer-when-downgrade"
                  title="DTU Campus Map - 03 Quang Trung"
                ></iframe>
                {/* Elegant map label */}
                <div className="absolute bottom-3 right-3 bg-[#0F2A4A] text-white text-[10px] font-bold uppercase tracking-wider py-1.5 px-3 rounded-lg shadow-md border border-[#D4AF37]/20 pointer-events-none">
                  DTU - 03 Quang Trung
                </div>
              </div>
            </div>
            ...
            <div className="clay-card p-4 sm:p-6 flex flex-col justify-between flex-1">
              <div>
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4 mb-3 sm:mb-4">
                  <h3 className="font-serif text-base sm:text-lg font-bold text-[#1A1A2E] flex items-center gap-2 flex-shrink-0">
                    <Compass className="w-4 h-4 sm:w-5 sm:h-5 text-[#0F2A4A] animate-pulse flex-shrink-0" /> <span className="hidden sm:inline">Sơ đồ dẫn đến Hội trường tầng 4</span><span className="sm:hidden">Sơ Đồ</span>
                  </h3>
                  <span className="text-[10px] sm:text-xs text-zinc-500 font-medium">Bấm vào các mốc</span>
                </div>
                
                {/* Pathway Visualizer */}
                <div className="relative h-24 sm:h-28 bg-[#0F2A4A]/5 rounded-2xl border border-[#0F2A4A]/10 flex items-center justify-between px-3 sm:px-6 mb-3 sm:mb-4 overflow-x-auto overflow-y-hidden">
                  {/* Sinuous dotted line */}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
                          isActive 
                            ? "bg-[#0F2A4A] text-[#F5F3EE] scale-110 sm:scale-125 ring-4 ring-[#0F2A4A]/20 shadow-md" 
                            : isPassed 
                              ? "bg-[#0F2A4A]/80 text-[#F5F3EE]" 
                        ...
                        <span className={`text-[8px] sm:text-[10px] mt-1 font-bold transition-colors ${
                          isActive ? "text-[#0F2A4A]" : "text-zinc-400 group-hover:text-zinc-600"
                        }`}>
                          M{idx + 1}
                        </span>
                      </button>
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="bg-white/50 p-3 sm:p-4 rounded-xl border border-[#0F2A4A]/10 flex items-start gap-2 sm:gap-3"
                >
                  <div className="p-1.5 sm:p-2 bg-[#0F2A4A]/10 rounded-lg text-[#0F2A4A] mt-0.5 flex-shrink-0">
                    <Info className="w-4 h-4 sm:w-4.5 sm:h-4.5" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-xs sm:text-sm text-[#1A1A2E]">
      ...
      <section className="relative w-full py-12 sm:py-16 px-3 sm:px-4 z-10 bg-[#0F2A4A]/3">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-[#0F2A4A] text-[10px] sm:text-xs font-bold uppercase tracking-widest bg-[#0F2A4A]/10 px-3 sm:px-3.5 py-1.5 rounded-full inline-block">
              Ký ức & Cột mốc
            </span>
            <h2 className="font-serif text-2xl sm:text-3xl md:text-5xl font-black text-[#1A1A2E] mt-3 sm:mt-4">
              Hành Trình Ý Nghĩa
            </h2>
            <div className="w-8 sm:w-12 h-1 bg-[#0F2A4A] mx-auto mt-3 sm:mt-4 mb-4 rounded-full" />
          ...
          <div className="relative">
            ...
            <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-[4px] bg-[#0F2A4A]/10 -translate-x-1/2 rounded-full hidden md:block" />
            {/* Side Line for mobile */}
            <div className="absolute left-4 top-0 bottom-0 w-[4px] bg-[#0F2A4A]/10 -translate-x-1/2 rounded-full md:hidden" />

            <div className="space-y-16">
              {/* Milestone 1: Freshman Year */}
              <div className="flex flex-col md:flex-row items-stretch md:justify-between relative">
                {/* Timeline node */}
                <div className="absolute left-4 md:left-1/2 w-8 h-8 rounded-full bg-[#0F2A4A] border-4 border-[#F5F3EE] -translate-x-1/2 flex items-center justify-center shadow-md z-20">
                ...
                >
                  <div className="clay-card p-4 sm:p-6 bg-white flex flex-col justify-between flex-1">
                    <div>
                      <span className="text-[#0F2A4A] text-[10px] sm:text-xs font-bold uppercase tracking-wider">2022 — Khởi Đầu Hành Trình</span>
                      <h3 className="font-serif text-base sm:text-xl font-bold text-[#1A1A2E] mt-1 mb-2 sm:mb-3">Bước chân vào giảng đường</h3>
                      <p className="text-zinc-500 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
                        Năm đầu tiên là quãng thời gian đầy bỡ ngỡ khi bước vào một môi trường hoàn toàn mới — bạn bè mới, thầy cô mới và phương pháp học tập mới. Đây cũng là lúc đặt những viên gạch nền tảng đầu tiên cho con đường chuyên môn, từng bước làm quen với tư duy lập trình và khám phá niềm đam mê với ngành Kỹ thuật phần mềm.
                      </p>
                    </div>
              ...
              <div className="flex flex-col md:flex-row-reverse items-stretch md:justify-between relative">
                ...
                >
                  <div className="clay-card p-4 sm:p-6 bg-white flex flex-col justify-between flex-1">
                    <div>
                      <span className="text-[#0F2A4A] text-[10px] sm:text-xs font-bold uppercase tracking-wider">2023 — Rèn Luyện và Thích Nghi</span>
                      <h3 className="font-serif text-base sm:text-xl font-bold text-[#1A1A2E] mt-1 mb-2 sm:mb-3">Vượt qua thử thách</h3>
                      <p className="text-zinc-500 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
                        Khi mọi thứ dần trở nên quen thuộc, các bài học không còn chỉ nằm trên trang giấy mà bắt đầu trở thành trải nghiệm thực tế qua từng đồ án môn học. Những đêm thức khuya hoàn thành bài tập lớn, chạy đua với thời hạn tuy đầy áp lực nhưng đã rèn giũa bản lĩnh, tính kỷ luật và sự kiên trì mỗi ngày.
                      </p>
                    </div>
                    {/* Glassmorphic Image Container */}
                    <div className="relative h-40 sm:h-48 w-full rounded-2xl overflow-hidden glass-card p-1">
              ...
              <div className="flex flex-col md:flex-row items-stretch md:justify-between relative">
                ...
                >
                  <div className="clay-card p-4 sm:p-6 bg-white flex flex-col justify-between flex-1">
                    <div>
                      <span className="text-[#0F2A4A] text-[10px] sm:text-xs font-bold uppercase tracking-wider">2024 — Bứt Phá và Trưởng Thành</span>
                      <h3 className="font-serif text-base sm:text-xl font-bold text-[#1A1A2E] mt-1 mb-2 sm:mb-3">Đồng hành cùng đồng đội</h3>
                      <p className="text-zinc-500 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
                        Một chặng đường đầy thử thách với những đồ án quy mô lớn, những buổi thuyết trình căng thẳng và cả những lúc cùng đồng đội miệt mài sửa lỗi chương trình đến sát giờ nộp. Qua đó, tôi học được cách lắng nghe, thấu hiểu giá trị của sự hợp tác và nhận ra rằng sự trưởng thành là một quá trình tích lũy từng ngày.
                      </p>
                    </div>
                    {/* Glassmorphic Image Container */}
                    <div className="relative h-40 sm:h-48 w-full rounded-2xl overflow-hidden glass-card p-1">
              ...
              <div className="flex flex-col md:flex-row-reverse items-stretch md:justify-between relative">
                ...
                >
                  <div className="clay-card p-4 sm:p-6 bg-white flex flex-col justify-between flex-1">
                    <div>
                      <span className="text-[#0F2A4A] text-[10px] sm:text-xs font-bold uppercase tracking-wider">2026 — Gặt Hái và Khởi Đầu Mới</span>
                      <h3 className="font-serif text-base sm:text-xl font-bold text-[#1A1A2E] mt-1 mb-2 sm:mb-3">Khoảnh khắc vinh danh</h3>
                      <p className="text-zinc-500 text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
                        Đồ án tốt nghiệp khép lại bốn năm đại học với bao cảm xúc vừa tự hào vừa lưu luyến. Thành quả đọng lại không chỉ là tấm bằng cử nhân, mà còn là những tình bạn tri kỷ, những bài học vô giá và ký ức thanh xuân tươi đẹp sẽ mãi đồng hành trong chương mới của cuộc đời.
                      </p>
                    </div>
                    {/* Glassmorphic Image Container */}
                    <div className="relative h-40 sm:h-48 w-full rounded-2xl overflow-hidden glass-card p-1">
      ...
      <section className="relative w-full max-w-6xl mx-auto px-3 sm:px-4 py-12 sm:py-16 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-start">
          ...
          >
            <span className="text-[#0F2A4A] text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-1.5 block">Sổ lưu niệm</span>
            <h2 className="font-serif text-xl sm:text-2xl md:text-3xl font-extrabold text-[#1A1A2E] mb-4 sm:mb-6">
              Gửi Lời Chúc Mừng
            </h2>
            ...
            <form onSubmit={handleWishSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 rounded-xl border border-zinc-200 focus:outline-none focus:ring-2 focus:ring-[#0F2A4A]/20 focus:border-[#0F2A4A] bg-[#F5F3EE] text-[#1A1A2E] text-sm transition-all shadow-inner"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3.5 rounded-xl border border-zinc-200 focus:outline-none focus:ring-2 focus:ring-[#0F2A4A]/20 focus:border-[#0F2A4A] bg-[#F5F3EE] text-[#1A1A2E] text-sm transition-all shadow-inner resize-none"
                />
              </div>
              ...
              <button
                ...
                className="btn-3d-navy w-full py-3 sm:py-4 px-4 sm:px-6 text-xs sm:text-sm flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer touch-manipulation"
              >
                {isSubmitting ? (
          ...
          >
            <div>
              <div className="flex items-center gap-2 mb-4 sm:mb-6 px-1 flex-wrap">
                <MessageSquare className="w-4 h-4 sm:w-5 sm:h-5 text-[#0F2A4A] flex-shrink-0" />
                <h3 className="font-serif text-lg sm:text-xl font-bold text-[#1A1A2E]">Lời Chúc Từ Mọi Người</h3>
                <span className="text-[10px] sm:text-xs bg-[#0F2A4A]/10 text-[#0F2A4A] px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full font-bold">
                  {wishes.length}
                </span>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`w-full h-full relative preserve-3d duration-500 transition-transform ${
                          ...
                          <div className={`absolute inset-0 backface-hidden rounded-2xl p-3 sm:p-5 flex flex-col justify-between border border-zinc-200/50 shadow-md ${getCardColor(wishes.indexOf(item))} hover:shadow-lg transition-shadow duration-300`}>
                            <div>
                              <div className="flex items-start justify-between gap-2">
                                <span className="font-serif text-sm sm:text-base font-bold text-[#1A1A2E] truncate">
                                  {item.name}
                                </span>
                            ...
                            <div className="flex justify-between items-center text-[8px] sm:text-[10px] text-[#0F2A4A] font-bold mt-2 pt-2 border-t border-zinc-100 gap-1">
                          ...
                          {/* Card Back (Flipped) */}
                          <div className="absolute inset-0 backface-hidden rotate-y-180 bg-[#0F2A4A] text-[#F5F3EE] rounded-2xl p-3 sm:p-6 flex flex-col justify-between border border-[#D4AF37]/15 shadow-lg">
            ...
            <div className="mt-10 sm:mt-14 p-4 sm:p-6 md:p-8 rounded-3xl bg-[#0F2A4A]/5 border border-[#0F2A4A]/15 relative overflow-hidden flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
              {/* Floating interactive 3D heart decoration */}
              <motion.div 
                whileHover={{ scale: 1.25, rotate: 10 }}
                whileTap={{ scale: 0.95 }}
                className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-2xl shadow-md flex items-center justify-center cursor-pointer text-[#D4AF37] border border-[#D4AF37]/20 flex-shrink-0 touch-manipulation"
              ...
              >
                <Heart className="w-6 h-6 sm:w-7 sm:h-7 fill-[#D4AF37] text-[#D4AF37] animate-pulse" />
              </motion.div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 sm:mt-4 flex justify-center sm:justify-end">
                  <div className="text-right">
                    <span className="font-serif text-base sm:text-lg font-bold text-[#D4AF37] tracking-wide block">
                      Bùi Lê Tuấn
                    </span>
